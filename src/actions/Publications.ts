...
export const getPublications: ActionCreator<ThunkAction<Promise<any>, StateType, void>> = () => {
    return (dispatch: Dispatch<StateType>) => {
...
export const getPublication: ActionCreator<ThunkAction<Promise<any>, StateType, void>> = (id: string) => {
    return (dispatch: Dispatch<StateType>) => {
...
export const updatePublication: ActionCreator<ThunkAction<Promise<any>, StateType, void>> = (pub: Publication) => {
    return (dispatch: Dispatch<StateType>) => {
...
export const deletePublication: ActionCreator<ThunkAction<Promise<any>, StateType, void>> = (id: string) => {
    return (dispatch: Dispatch<StateType>) => {
